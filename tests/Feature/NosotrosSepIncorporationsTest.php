...
class NosotrosSepIncorporationsTest extends TestCase
{
    ...
    public function test_sep_incorporations_include_the_school_name_and_level_colors(): void
    {
        ...
        $response->assertSee('Kindergarten: 21PJN0912U - Colegio Discovery Nuevo Millenium');
        $response->assertSee('Elementary: 21PPR0078B - Colegio Discovery Nuevo Millenium');
        $response->assertSee('Middle School: 21PES0097J - Colegio Discovery Nuevo Millenium');
        $response->assertSee('High School: 21PBH0513D - Colegio Discovery Nuevo Millenium');
